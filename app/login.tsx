        ...
        <div>
            <div className="h-screen flex flex-col justify-center items-center">
                <div className="bg-white border border-gray-300 w-80 py-8 flex items-center flex-col mb-3">
                    <h1 className={["bg-no-repeat",styles.instagram_logo].join(" ")}></h1>
                    ...
                    <button className="mt-4 flex">
                        <div className={["bg-no-repeat", styles.facebook_logo, "mr-1"].join(" ")}></div>
                ...
                <div className="mt-3 text-center">
                    ...
                    <div className="flex mt-3 space-x-2">
                        <div className={["bg-no-repeat", styles.apple_store_logo].join(" ")}></div>
                        <div className={["bg-no-repeat", styles.google_store_logo].join(" ")}></div>
                    </div>
                </div>
            </div>
        </div>
